...
var MessageServer = require('./adapters/server');
...
var Container = function(config) {
    ...
    this.init = function(serviceName, moduleName, callback) {
        ...
        self.getService('MANAGER').then(function(service) {
    ...
    this.getService = function(name) {
        ...
        if(name === '') {
            ...
            name = routeTable.getNextServiceName(this.serviceName, this);
        }

        return routeTable.getService(name, this);
    };
    ...
    this.broadcast = function(command, req, callback) {
        ...
        routeTable.broadcast(command, req, this, callback);
    };
    ...
    this.log = log;
    this.log.init(this.getConfig('log'));

    var messageServer = new MessageServer(this);
};
